...
import entitysToModelsPostMysqlDatabase from "../../infrastructure/persistence/mysql/helpers/entitysToModels.post.mysql.database";
import modelToEntitysPostMysqlDatabase from "../../infrastructure/persistence/mysql/helpers/modelToEntitys.post.mysql.database";
...
// import * as jwt from "jsonwebtoken"
 ...
 export class PostRepository implements IPostRepository{
    ...
    async create(resource: IPostEntity): Promise<IPostEntity> {
        const { posts } = entitysToModelsPostMysqlDatabase(resource);
    ...
    async list(): Promise<IPostEntity[]> {
        ...
        const clients = posts.map(modelToEntitysPostMysqlDatabase)
        return clients;
    }
